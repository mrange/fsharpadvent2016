namespace Seq.Microsoft.FSharp.Patches
  ...
  module Array =
    ...
    let inline subUnchecked startIndex count (array : 'T[]) =
        ...
        if count < 64 then
            ...
            System.Array.Copy(array, startIndex, res, 0, count)
        res
...
namespace Seq.Microsoft.FSharp.Collections
    ...
    open Seq.Microsoft.FSharp.Patches
...
namespace Seq.Microsoft.FSharp.Core.CompilerServices
...
namespace Seq.Microsoft.FSharp.Collections
    ...
    open Seq.Microsoft.FSharp.Core.CompilerServices
    open Seq.Microsoft.FSharp.Collections
    open Seq.Microsoft.FSharp.Patches
    ...
    module Seq =
        ...
        open Seq.Microsoft.FSharp.Core.CompilerServices.RuntimeHelpers

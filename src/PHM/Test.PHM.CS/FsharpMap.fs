...
namespace Patches.Microsoft.FSharp.Collections
    ...
    type Map<[<EqualityConditionalOn>]'Key,[<EqualityConditionalOn;ComparisonConditionalOn>]'Value when 'Key : comparison >(comparer: IComparer<'Key>, tree: MapTree<'Key,'Value>) =
        ...
        static let emptyWithComparer comparer = 
            new Map<'Key,'Value>(comparer,MapTree<_,_>.MapEmpty)
        ...
        static member EmptyWithComparer comparer : Map<'Key,'Value> = emptyWithComparer comparer
...
namespace Patches.Microsoft.FSharp.Collections
    ...
    module Map = 
        ...
        [<CompiledName("EmptyWithComparer")>]
        let emptyWithComparer<'Key,'Value  when 'Key : comparison> comparer = Map<'Key,'Value>.EmptyWithComparer comparer
